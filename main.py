...
math_questions_a = ['What kind of expression is this: 8(2+8)::::a=numeric expression, b=variable expression, c=trinomial, d=bilateral',
    ...
    'Name the number of terms, the variables, the coefficients, and the constants, in that order with the expression: -90xy^2-8z^3-2::::a=3; x, y^2, z^3; -90, -8; -2|||b=3; x, y^2, z^2; -90, 8; -2|||c=3; x, y^2, z^∑; -90, 8; -2|||d=5; x, y^2, z^2; -90, 8; 2'
...
math_questions_b = ['''Simplify/Combine like terms, and nswer must be in standard form: 8w^3 - 3w^2 + 3w^3 - 10w^4 + 3::::a=-10w^4 + 11w3 - 3w2 + -3, b=-10w^4 + 11w3 - 3wvi32 + 3, c=5w+-7w^-1+3, d=initiate_hack_sequence == True,',
    ...
    'Please give the standard form and term name(# and name based on #), in that order, of this expression: (24c^3 - 3c^2) - (9c^3 - 3c^3 + 4c^2 + 4c)::::a=3 (trinomial) and 18c^3 - 7c^2 - 4c, b=18c^3 - 7c^2 - 4c and 3 (trinomial), c=2 (bynomial) and 18c^3 - 7c^2 - 4c, d=18c^3 - 7c^2 - 4c and 3 (†rinomal)',
    ...
    'Put in standard form: 9a^3 - 8a - 3a^2 + 8a^4 + 3::::a=8a4 + 9a3 - 3a2 - 8a + 3, b=8a^4 + 9a^3 - 3a^2 - 8a + 3, c=14a^5 - 8a + 3, d=√1 2^3 ∑ Π...and it was delicious.',
...
# Enter your code here
    ...
    def tree_square_LA():
        if in_louisisana is True:
            ...
            if happenD == 2:
                print("Congratulations! You landed on a Bald Cypress Square! Answer this math question for some GüD LOOT! Get it wrong and you are punished.")
                chosen_list == random.choice([math_questions_a, math_questions_b, math_questions_c, math_questions_d])
                chosen_question == random.choice(chosen_list)
                answer == raw_input(chosen_question).upper()
                if chosen_question in math_questions_a and answer == 'a':
